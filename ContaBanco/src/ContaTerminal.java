        ...
        int operacao = ler.nextInt();
            ...
            while (true) {
               ...
               // System.out.println(numeroTelefone);
                ...
                // Condição verdadeira para caso o usuário informe o cep errado,  possa digitar novamente continuando do mesmo ponto em que está. (Não valida o CEP, apenas confere se foi digitada da forma correta)
                while (true) {
